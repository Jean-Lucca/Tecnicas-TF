...
public class Servicos {
	...
	public  double calculaDiaria(FiltroDTO filtro, double preco) {
		return calculaDias(filtro) * preco;
	}
	...
	public double calculaTotal(FiltroDTO filtro, double preco) {
		return Math.round((calculaDiaria(filtro, preco) + calculaSeguro(filtro)) * calculaDesconto(filtro));
	}
